...
export function UserWithSearchIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
...
"
        ...
        >
            ...
            <path d="M3.41016 22C3.41016 18.13 7.26018 15 12.0002 15" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />

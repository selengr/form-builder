              ...
              <div className='w-full flex flex-col justify-center gap-4 rounded-[20px] bg-[#F7F7FF] px-4 pt-4 pb-3'>
                <FormControl
                  ...
                  <RadioGroup
                    ...
                    <FormControlLabel value='INAPPROPRIATE_CONTENT' control={<Radio />} label='محتوا نامناسب' />
                    <FormControlLabel value='PRIVACY_VIOLATION' control={<Radio />} label='نقض حریم خصوصی' />
                    <FormControlLabel value='INTELLECTUAL_PROPERTY_INFRINGMENT' control={<Radio />} label='مالکیت معنوی' />
                    <FormControlLabel value='OTHER' control={<Radio />} label='سایر' />
                  </RadioGroup>
                </FormControl>
              </div>

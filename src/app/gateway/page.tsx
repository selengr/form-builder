...
// import { Autocomplete, Box, Button, Divider, Typography, useTheme } from "@mui/material";
...
// } from "./types";
// import { connectToGateway, issueRequest, serviceCost } from "./actions";
// import { confirmPayment, userCreditList } from "./actions";
...
//     mutationFn: () => serviceCost(+params.planId),
//   });

//   // const { data } = useQuery({
//   //   queryKey: ["serviceCost"],
//   //   queryFn: () => serviceCost(+params.planId),
//   // });
...
//         let remained = +data?.serviceCost - totalCredit;
...
//     if (index === 0) {
//       return Math.max(item.availableAmount - +data?.serviceCost, 0);
//     }
...
//         0
//       );
//     const remained = Math.max(+data?.serviceCost - prevItemsAmount, 0);
...
//           router.back();
//         } else if (data.serviceCost === prevServiceCost) {
//           nextStep();
//         } else {
//           router.back();
//         }
...
//       onSuccess: (data) => {
//         setRemainedAmount(+data?.serviceCost);
//         setPrevServiceCost(data.serviceCost);
//         if (data.serviceCost === 0) {
...
//                 fontWeight="bold"
//               >
//                 {/* {formatNumberWithCommas(data?.serviceCost)} تومان */}
//                 ljkhg
//               </Typography>
//             </Box>
...
//           sendOtpInfo={{
//             url: (nationalCode) =>
//               `/communitycharge/service-cost/send-otp?nationalcode=${nationalCode}&issueRequestId=${issueReques?.issueRequestId}`,
//           }}
//           resendOtpInfo={{
//             body: (data) => ({
//               otpId: data.id,

...
const mockUsersData: IUser[] = [{id: 101, name: 'علی احمدی', email: 'ali.ahmadi@example.com'}, {
  id: 102,
  name: 'زهرا کریمی',
...
export default function GroupDetailsPage() {
  ...
  if (!group && groupId) {
    return (<div className="p-2 w-full h-[calc(100vh - 60px)] md:h-screen flex flex-col items-center justify-center">
  ...
  if (!group && !groupId) {
    return (<div className="p-2 w-full h-[calc(100vh - 60px)] md:h-screen flex flex-col items-center justify-center">
        ...
        <button
          ...
          className="mt-4 px-4 py-2 bg-[#1758BA] text-white rounded-lg hover:bg-[#216ee1] transition"
        >
  ...
  return (<div className="p-2 w-full h-[calc(100vh - 60px)] md:h-screen flex flex-col" draggable={false}>
      <main className="p-4 bg-white flex flex-col rounded-xl h-full">
        ...
        <div className="min-h-[52px] flex items-center justify-center relative rounded-xl bg-[#F7F7FF] mb-4 px-2">
          ...
          <button
            ...
            className="absolute left-2 p-1 rounded-full hover:bg-gray-200"
          ...
          <div className="flex justify-between items-center mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <FormControlLabel
                ...
                label="انتخاب همه"
                sx={{
                  marginRight: '8px', marginLeft: '0px', '.MuiFormControlLabel-label': {
      ...
      {showEditGroupDialog && (<CreateGroupDialog
          onClose={() => router.back()}

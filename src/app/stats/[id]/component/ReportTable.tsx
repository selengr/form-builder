    ...
    deleteTakePart(
      ...
      },
      {
        onSuccess: () => {
          ...
          const updatedSelected = selectedUsers.filter((u) => u.takePartId !== deleteTarget.takePartId);
          ...
          <>
            <div className="flex flex-row items-center gap-2 mt-2">
              ...
              <p className="font-normal">
                آیا از حذف ردیف <span className="font-semibold">{deleteTarget?.name}</span> اطمینان دارید؟
              </p>
            </div>
          </>
        }

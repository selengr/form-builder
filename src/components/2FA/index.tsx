...
export default function TwoFABottomSheet<T>({ open, sendOtpInfo, resendOtpInfo, otpLength = 6, isLoadingConfirmation, onClose, onConfirm = () => {} }: TwoFABottomSheetProps<T>) {
  ...
  const [currentActiveBottomSheet, setCurrentActiveBottomSheet] = useState<'NATIONAL_CODE' | 'OTP'>('NATIONAL_CODE');
  ...
  return (
    <>
      ...
      <BottomSheet
        ...
        onClose={handleClose}>
        <Box padding='1rem'>
          <Typography variant='body2'>کد احراز به شماره همراه {sendOtpResponse?.username} با سرشماره 50004848 پیامک شد. کد ارسال شده را وارد کنید.</Typography>
          ...
          <Box display='flex' justifyContent='center' alignItems='center' marginY='2rem'>
            <Countdown
              key={timer}
              ...
              renderer={({ minutes, seconds, completed }) =>
                completed ? (
                  ...
                  <>
                    ...
                    <Typography fontSize='0.8rem' marginLeft='0.4rem' color={palette.grey[700]}>

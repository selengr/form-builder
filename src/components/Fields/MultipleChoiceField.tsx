...
const questionPropertyList: IQPLMultipleChoice = [{
    id: 1, questionPropertyEnum: "MULTI_SELECT", value: "false",
}, {
    id: 2, questionPropertyEnum: "REQUIRED", value: "false",
}, {
    id: 3, questionPropertyEnum: "RANDOMIZE_OPTIONS", value: "false",
}, {
    id: 4, questionPropertyEnum: "DESCRIPTION", value: "",
}, {
    id: 5, questionPropertyEnum: "EDIT_ANSWER_LOCKED", value: "false",
},];

const optionList: IFormOptionList[] = [{
    title: "گزینه 1", score: 1,
}, {
    title: "گزینه 2", score: 2,
},];
...
const propertiesSchema = z.object({
    title: z
        ...
        .pipe(z
            ...
            .max(3999, {message: "حداقل باید 1 و حداکثر 4000 کاراکتر باشد"})), DESCRIPTION: z.object({
        value: z
            .string()
            .trim()
            .transform((value) => value.replace(/\s+/g, " "))
        ...
        value: z.boolean().default(false), id: z.number(),
...
export const MultipleChoiceFormElement: FormElement = {
    questionType, construct: ({
                                  questionId, questionGroupId, formId, title, position,
        ...
        label: "چند گزینه‌ای", icon: TickIcon,
    }, designerComponent: DesignerComponent, formComponent: FormComponent, propertiesComponent: PropertiesComponent,
...
type CustomInstance = FormElementInstance & {
    questionPropertyList: typeof questionPropertyList; optionList: typeof optionList;
};
...
function PropertiesComponent({
    ...
    const [openDescriptionSwitch, setOpenDescriptionSwitch] = useState<boolean>(() => element.questionPropertyList.some((property) => {
    ...
    const defaultValues = useMemo(() => {
        const values = element.questionPropertyList.reduce((acc: any, attribute: any) => {
            ...
            if (attribute.questionPropertyEnum === "REQUIRED" || attribute.questionPropertyEnum === "RANDOMIZE_OPTIONS" || attribute.questionPropertyEnum === "MULTI_SELECT" || attribute.questionPropertyEnum === "EDIT_ANSWER_LOCKED") {
    ...
    const methods = useForm<propertiesFormSchemaType>({
        resolver: zodResolver(propertiesSchema), mode: "onSubmit", defaultValues,
    });

    const {
        reset, handleSubmit, formState: {isSubmitting, errors},
    } = methods;

    async function onSubmit(values: propertiesFormSchemaType) {
        const {
            title, DESCRIPTION, REQUIRED, RANDOMIZE_OPTIONS, MULTI_SELECT, optionList, EDIT_ANSWER_LOCKED,
        } = values;
    ...
    return (<FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
            ...
            >
                ...
                {openDescriptionSwitch && (<Stack marginTop={2}>

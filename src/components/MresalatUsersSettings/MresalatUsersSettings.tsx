  ...
  return (
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
      <Box
        ...
        <Box display='flex' flexDirection='column' justifyContent='center' alignItems='center' gap='16px' width='100%' px={2}>
          <Typography fontSize='13px' fontWeight='700' mt={2} textAlign='center'>

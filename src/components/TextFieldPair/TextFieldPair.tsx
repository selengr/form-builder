...
export default function TextFieldPair({ setValue, clearErrors, initialShow }: any) {
  ...
  return (
    <>
      <div className='flex flex-col gap-2 mt-5'>
        ...
        <RHFMultiSelect name='TEXT_FIELD_PATTERN.value' options={fieldPatternOptions} setProp={setShowMinMaxProps} clearErros={clearErrors} setValue={setValue} />
      </div>

    ...
    <Dialog
      ...
      <DialogContent
        ...
        <Box
          ...
          <LuRocket size={34} color="#1758BA" strokeWidth={2.25} />
        </Box>
        ...
        <Box
          ...
          <Typography fontSize="14px" fontWeight={500} color="#393939" lineHeight={1.9}>
            پس از نهایی کردن فرم، امکان ویرایش یا تغییر آن وجود نخواهد داشت.
          </Typography>
          <Box
            sx={{
              mt: 1.5,
            ...
            <Typography fontSize="13px" fontWeight={600} color="#1758BA">
              آیا از انتشار این فرم مطمئن هستید؟
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, width: '100%' }}>
          ...
          <Button
            ...
            {loading ? <CircularProgress size={22} color="inherit" /> : 'انتشار فرم'}
          </Button>
        </Box>
      </DialogContent>
    </Dialog>

...
const RHFTextFieldOptionList = memo(function RHFTextFieldOptionList({ name, errorMessage }: PropTypes) {
  ...
  return (
    <Fragment>
                ...
                <Box display='flex' flexDirection='column'>
                  <Box display='flex' justifyContent='space-between' alignItems='center' gap={0.8}>
                    ...
                    <IconButton
                      ...
                      <BsTrash3 width={24} height={24} size='1.3rem' color='#FA4D56' />
                    </IconButton>
                  </Box>
                  <Typography
                    sx={{
      ...
      <Box display='flex' justifyContent='center' alignItems='flex-start' flexDirection='column' gap={0.8} mt='7px'>
        {fields.length < 10 ? (
          <Box display='flex' justifyContent='space-between' alignItems='center' flexDirection='row' gap={0.8}>
            <TextField
              fullWidth
              sx={{
                '& input': {

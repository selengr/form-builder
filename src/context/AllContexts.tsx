...
export const ActionDesignerContext = createContext<ActionDesignerContextType | null>(null);

/* ---------------------------- Elements Context: Value & Action ---------------------------- */
export const ActionElementsContext = createContext<Dispatch<SetStateAction<FormElementInstance[]>> | null>(null);
export const ElementsContext = createContext<FormElementInstance[] | null>(null);

/* --------------------------- Open Dialog Context: Value & Action -------------------------- */
export const ActionOpenDialogContext = createContext<Dispatch<SetStateAction<boolean>> | null>(null);
...
export const ActionOpenBottomSheetContext = createContext<Dispatch<SetStateAction<boolean>> | null>(null);

...
const DesignerElementNoDnD = memo(function DesignerElementNoDnD({ element }: { element: FormElementInstance }) {
  const DesignerElement = FormElements[element?.questionType as ElementsType].designerComponent;

  return (
    <div dir='rtl' className='flex items-center h-[65px] w-full relative border-[1px] border-[#1758BA] rounded-xl justify-start flex-row p-2 bg-white'>

...
function DragHandleSkeleton() {
  return (
    <div className="flex items-center justify-center w-8 shrink-0">
      <Block className="h-5 w-3 rounded-sm bg-gray-100" />
    </div>
  );
}
...
function CalculatorCardSkeleton() {
  return (
    <div className="flex items-stretch gap-2 w-full">
      ...
      <div
        dir="rtl"
        className="relative flex-1 min-w-0 min-h-[56px] rounded-xl border border-[#DDE1E6] bg-white px-2 py-2 flex items-center gap-3 pl-12"
      >
...
function ConditionCardSkeleton() {
  return (
    <div className="flex items-stretch gap-2 w-full">
      ...
      <div
        dir="rtl"
        className="relative flex-1 min-w-0 rounded-xl border border-[#DDE1E6] bg-white p-3 pl-12"
      >

...
interface PublicFormFilterProps {
...
export default function PublicFormFilter({
  mode,
  filter,
  onChange,
  onApply,
  onReset,
}: PublicFormFilterProps) {
            ...
            <FormControl
              ...
              <RadioGroup
                ...
                onChange={(event) =>
                  onChange((prev) => ({
                    ...prev,
                    isCreatedSoloReport: event.target.value,
                  }))
                }>
                <FormControlLabel value="ALL" control={<Radio />} label="همه" />
            ...
            <FormControl
              ...
              <RadioGroup
                ...
                onChange={(event) =>
                  onChange((prev) => ({
                    ...prev,
                    fieldOperation: event.target.value,
                  }))
                }>

...
const ConditionList: React.FC<IConditionListProps> = ({ conditions, setConditions }) => {
  const { id } = useParams();
  ...
  return (
    <>
      <div className='w-full max-w-[520px] -mr-3'>{!admin && <CreateCondition />}</div>
      <div className='w-full overflow-y-auto flex justify-center'>
        <div className='w-full max-w-[500px] flex flex-col'>
          {Array.isArray(conditions) && conditions.length > 0 && (
            <div dir='rtl' className='rounded-lg p-[10px] w-full flex flex-col gap-3 -pb-10 mb-0'>
